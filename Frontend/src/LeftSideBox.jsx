...
export const LeftSideBox = () => {
  ...
  const data = false;
  return (
    <div className="bg-[#171717] text-opacity-70 w-[30%]  p-3 text-white flex flex-col gap-6 h-screen ">
      ...
      {data == true ? (
        ...
        <div className="flex justify-center flex-col items-center h-[300px] gap-4">
